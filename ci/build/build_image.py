...
class ImageBuildConfig:
    ...
    def from_args(
        ...
        *,
        ...
        java_image = "scratch" if no_java else f"{RAYCI_REGISTRY}/ray-java-build{ray_image.arch_suffix}"
        dashboard_image = "scratch" if no_dashboard else f"{RAYCI_REGISTRY}/ray-dashboard{ray_image.arch_suffix}"
